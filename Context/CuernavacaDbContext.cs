...
using gcomercial_api.Models.Cuernavaca;

namespace gcomercial_api.Context;

public partial class CuernavacaDbContext : DbContext
{
    public CuernavacaDbContext()
    {
    }

    public CuernavacaDbContext(DbContextOptions<CuernavacaDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=10.0.0.47;Database=adSUC_CUERNAVACA;User Id=ConsultaTI;Password=FKos2725;TrustServerCertificate=true;Encrypt=false;");
