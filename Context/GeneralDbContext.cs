...
using gcomercial_api.Models.General;
...
public partial class GeneralDbContext : DbContext
{
    ...
    public virtual DbSet<IdsPresupuestosAgente> IdsPresupuestosAgentes { get; set; }

    public virtual DbSet<IdsViewAgentesPresupuestoVenta> IdsViewAgentesPresupuestoVentas { get; set; }

    public virtual DbSet<IdsViewVentasClienteAgenteProductoAnioMe> IdsViewVentasClienteAgenteProductoAnioMes { get; set; }

    public virtual DbSet<LmcViewComprasProveedorProductAnioMe> LmcViewComprasProveedorProductAnioMes { get; set; }

    public virtual DbSet<LmcViewVentasClienteAgenteProductoAnioMesDia> LmcViewVentasClienteAgenteProductoAnioMesDias { get; set; }

    public virtual DbSet<LmcViewVentasClientesAgenteProductoAnioMesSdnc> LmcViewVentasClientesAgenteProductoAnioMesSdncs { get; set; }

    public virtual DbSet<LmcViewVentasClientesAgenteProductoAnioMesSnc> LmcViewVentasClientesAgenteProductoAnioMesSncs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=10.0.0.47;Database=adDRT_GENERAL;User Id=ConsultaTI;Password=FKos2725;TrustServerCertificate=true;Encrypt=false;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AdmMovimiento>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Ciddocumento, e.Cmovtooculto }, "CIDMOVTOCNUMMOVUCU");

            entity.HasIndex(e => new { e.Ciddocumento, e.Cmovtooculto }, "CIDMOVTOCNUMMOVUCU2");
            ...
            entity.HasIndex(e => new { e.Cidproducto, e.Cidalmacen, e.Cafectadoinventario, e.Cfecha }, "IDXCTOESPAFECTAEXIXT");

            entity.HasIndex(e => new { e.Cidproducto, e.Cidalmacen, e.Cafectadoinventario, e.Cfecha }, "IDXCTOESPIDPRODIDMOVTO");
            ...
            entity.HasIndex(e => new { e.Ciddocumento, e.Cidproducto, e.Cmovtooculto }, "ciddoctoprodmovoc");
        ...
        modelBuilder.Entity<IdsPresupuestosAgente>(entity =>
        {
            entity.HasKey(e => e.Id)
                .HasName("PK__IdsPresu__3214EC27BB4A586C")
                .HasFillFactor(80);

            entity.ToTable("IdsPresupuestosAgente");
        ...
        modelBuilder.Entity<IdsViewAgentesPresupuestoVenta>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("IdsViewAgentesPresupuestoVentas");

            entity.Property(e => e.Cidagente).HasColumnName("cidagente");
        });

        modelBuilder.Entity<IdsViewVentasClienteAgenteProductoAnioMe>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("IdsViewVentasClienteAgenteProductoAnioMes");
        ...
        modelBuilder.Entity<LmcViewComprasProveedorProductAnioMe>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("LmcViewComprasProveedorProductAnioMes");
        ...
        modelBuilder.Entity<LmcViewVentasClienteAgenteProductoAnioMesDia>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("LmcViewVentasClienteAgenteProductoAnioMesDias");
        ...
        modelBuilder.Entity<LmcViewVentasClientesAgenteProductoAnioMesSdnc>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("LmcViewVentasClientesAgenteProductoAnioMesSDNC");
        ...
        modelBuilder.Entity<LmcViewVentasClientesAgenteProductoAnioMesSnc>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("LmcViewVentasClientesAgenteProductoAnioMesSNC");
